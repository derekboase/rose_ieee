...
class RandomTrajectory:
    ...
    def signal_update(self):
        ...
        plt.subplot(2, 2, 1)
        plt.plot(time_plt, np.rad2deg(self.j1_traj[0:len(time_plt)]))
        plt.plot(time_plt, np.rad2deg(y1))

        plt.subplot(2, 2, 2)
        plt.plot(time_plt, np.rad2deg(self.j2_traj[0:len(time_plt)]))
        plt.plot(time_plt, np.rad2deg(y2))

        plt.subplot(2, 2, 3)
        plt.plot(time_plt, np.rad2deg(self.j3_traj[0:len(time_plt)]))
        plt.plot(time_plt, np.rad2deg(y3))

        plt.subplot(2, 2, 4)
        plt.plot(time_plt, np.rad2deg(self.j4_traj[0:len(time_plt)]))
        plt.plot(time_plt, np.rad2deg(y4))
        plt.show()

        print(np.array(time_plt).reshape(-1,1).shape)
        print(np.array(self.j1_traj[0:len(time_plt)]).reshape(-1,1).shape)
        print(np.array(y1[0:len(time_plt)]).reshape(-1,1).shape)

        data = np.concatenate((np.array(time_plt).reshape(-1, 1),
                               np.rad2deg(np.array(self.j1_traj[0:len(time_plt)]).reshape(-1, 1)),
                               np.rad2deg(np.array(self.j2_traj[0:len(time_plt)]).reshape(-1, 1)),
                               np.rad2deg(np.array(self.j3_traj[0:len(time_plt)]).reshape(-1, 1)),
                               np.rad2deg(np.array(self.j4_traj[0:len(time_plt)]).reshape(-1, 1)),
                               np.rad2deg(np.array(y1[0:len(time_plt)]).reshape(-1, 1)),
                               np.rad2deg(np.array(y2[0:len(time_plt)]).reshape(-1, 1)),
                               np.rad2deg(np.array(y3[0:len(time_plt)]).reshape(-1, 1)),
                               np.rad2deg(np.array(y4[0:len(time_plt)]).reshape(-1, 1))), axis=1)

        filename = str(raw_input("Enter a filename:"))
        filepath = '/home/keenan/catkin_ws/src/rose_ieee/data/comp_algo/' + filename + '.csv'
